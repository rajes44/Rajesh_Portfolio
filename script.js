...
function initParticleBurst() {
  document.querySelectorAll('.btn, .project-link, .social-icon, .contact-card-link').forEach(btn => {
...
function initTilt() {
  document.querySelectorAll('.project-card, .about-card, .contact-card-link').forEach(card => {
